...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // I DID THAT ^
        // He's doing the Bedroom.
        // He clearly does it better.
        ...
        Bedroom thePrincesRoom = new Bedroom("Alex's", wall1, wall2, wall3, wall4, ceiling, bed, lamp);

        thePrincesRoom.makeBed();
        thePrincesRoom.getLamp().turnOn();
    }
}
